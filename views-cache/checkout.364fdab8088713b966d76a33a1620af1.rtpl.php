								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<p id="billing_number_1_field" class="form-row form-row-wide number-field validate-required">
													...
													<input type="text" value="<?php echo htmlspecialchars( $address["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Número" id="billing_desnumber_1" name="desnumber" class="input-text ">
												</p>
											</div>
										</div>
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state" style="margin:15px; display:inline-flex">
												<input type="radio" id="method-pagseguro" name="payment-method" placeholder="País" value="1">
												<label class="" for="method-pagseguro"><img src="/resources/site/img/logo-pagseguro.png" style="height:60px"/></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state" style="margin:15px; display: inline-flex;">
												<input type="radio" id="method-paypal" name="payment-method" placeholder="País" value="2">
												<label class="" for="method-paypal"><img src="/resources/site/img/logo-paypal.png" style="height:60px"/></label>
											</p>
											<div id="payment">
